...
import com.example.moviebooking.data.remote.entities.tmdb.movie.SimilarItem
import com.example.moviebooking.databinding.SimilarMovieItemBinding
import com.example.moviebooking.domain.common.Const

class SimilarMovieAdapter : BaseListAdapter<SimilarItem, SimilarMovieItemBinding>() {
