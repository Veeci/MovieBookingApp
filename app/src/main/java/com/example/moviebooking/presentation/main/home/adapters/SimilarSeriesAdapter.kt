...
import com.example.moviebooking.data.remote.entities.tmdb.series.SimilarSerieItem
import com.example.moviebooking.databinding.SimilarMovieItemBinding
import com.example.moviebooking.domain.common.Const

class SimilarSeriesAdapter : BaseListAdapter<SimilarSerieItem, SimilarMovieItemBinding>() {
